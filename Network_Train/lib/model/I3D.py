...
class InceptionI3d(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        # return logits.squeeze(), (f1, f2, f3)
        return res, (f1, f2, f3)
...
def Network(num_classes, local_rank, pretrained=None):
    Net = InceptionI3d(num_classes=num_classes)
    if pretrained:
...
if __name__ == '__main__':
    ...
    model = InceptionI3d(num_classes, in_channels=3).cuda()

    inputs = torch.randn(2, 3, 32, 224, 224).cuda() # shape (C x T x H x W)
